...
/**
 * Adapter: subscribes to LabTestArchived and creates/updates ICD10
 */
class ArchivedLabTestToICD10Subscriber
{
    ...
    public function handle(LabTestArchived $event): void
    {
        // TODO: Implement logic to react to LabTestArchived
